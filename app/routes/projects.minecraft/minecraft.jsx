...
const title = 'MineCraft ThreeJS';
const description =  'A minimalistic minecraft clone made in ThreeJS and ReactJS';
    ...
    <Fragment>
      <ProjectContainer className={styles.slice}>
        ...
        <ProjectHeader
          ...
          url="https://minecraftthree.netlify.app/"
          roles={roles}
        />
        <ProjectSection padding="top">
          <ProjectSectionContent>
            <ProjectImage
              ...
              alt="The minecraft web application."
