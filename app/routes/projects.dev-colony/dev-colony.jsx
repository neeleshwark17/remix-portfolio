...
import styles from './dev-colony.module.css';
...
const title = 'Dev Colony - A mentorship program platform!';
const description =
  'Learn and grow together with the help of the best mentors';
const roles = [
  'React',
  'Firebase',
];
      ...
      <ProjectContainer>
        ...
        <ProjectSection padding="top">
          <ProjectSectionContent>
            <ProjectImage
              ...
              srcSet={
                isDark
                  ? `${devcolony} 1280w, ${devcolony} 2560w`
                  : `${devcolony} 1280w, ${devcolony} 2560w`
              }
              width={1280}
              height={800}
        ...
        <ProjectSection>
          <ProjectTextRow>
            ...
            <ProjectSectionText>
              Built on react using tailwind css and firebase services for storing data and other functionalities. Its a mentorship program where
              students can get mentor advices for free via one on one sessions and people can also become a part of this by becoming a mentor.
            </ProjectSectionText>
          </ProjectTextRow>
        </ProjectSection>
