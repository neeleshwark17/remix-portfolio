...
abstract: Working in Sleepiz AG as an Full Stack Engineer, developing both mobile and web apps using ReactJS,NextJS and React Native; Building and working on software architecture and design ascpects.
date: '07/01/2025'
