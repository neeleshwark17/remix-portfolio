---
title: 'Quepplin: Application Engineer'
abstract: Worked in Quepplin as an Application Engineer, standard web apps and web-3 using solidity (Writing smart contracts), developing NFT marketplaces and custom coins/chains also worked on mobile app development, using 3D frameworks like 8th wall.
date: '07/01/2022'
date_label: 'October 2021 – July 2022'
banner: /static/quepplin.jpg
link: 'queppelin.com'
---
