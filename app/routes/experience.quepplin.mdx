...
abstract: Worked in Quepplin as an Application Engineer, standard web apps and web-3 using solidity (Writing smart contracts), developing NFT marketplaces and custom coins/chains also worked on mobile app development also 3D frameworks like 8th wall.
date: '07/01/2022'
